...
* Once you're happy with the changes scroll down to the bottom of the page and click "Propose file change" as shown in the image below.

![](./images/propose_file_change.png)
* That will take you to the next page allowing you to submit a pull request. Once that is done I will receive an email and all your changes, and I will be able to review your translations and integrate them. You will be notified by email when I accept your changes.
