...
translated (by machine 🤖) as:
```
Використовувати рідний вигляд Google Maps
```
...
translated (by machine 🤖) as:
```
Цей режим відображення може бути повільнішим, але менш імовірно призведе до збоїв програми
```
...
translated (by machine 🤖) as:
```
(поточний вибір не застосовано, потрібен повний перезапуск програми)
```
