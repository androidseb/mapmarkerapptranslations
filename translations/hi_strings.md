...
translated (by machine 🤖) as:
```
क्या आप किसी अन्य स्रोत से खोजना पसंद करेंगे?
```
...
translated (by machine 🤖) as:
```
आश्चर्य है कि खोज स्रोतों को कैसे कॉन्फ़िगर किया जाए? यहां क्लिक करे।
```
...
translated (by machine 🤖) as:
```
खोज स्रोत जोड़ें या कॉन्फ़िगर करें
```
...
translated (by machine 🤖) as:
```
खोज स्रोत कॉन्फ़िगरेशन परीक्षण सफल रहा! इस खोज स्रोत के साथ खोज को अब काम करना चाहिए।
```
...
translated (by machine 🤖) as:
```
चेतावनी: खोज स्रोत कॉन्फ़िगरेशन परीक्षण विफल हुआ। इस खोज स्रोत के साथ खोज कार्य नहीं कर सकता है।
```
...
translated (by machine 🤖) as:
```
इस फ़ोल्डर में उप-फ़ोल्डर हैं। क्या आप उप-फ़ोल्डर्स को भी हटाना चाहते हैं? हटाए गए फ़ोल्डरों से संबंधित सभी मार्कर स्थायी रूप से हटा दिए जाएंगे!
```
...
translated (by machine 🤖) as:
```
क्या आप वाकई इन फ़ोल्डरों को हटाना चाहते हैं? इन फ़ोल्डरों से संबंधित सभी मार्कर स्थायी रूप से हटा दिए जाएंगे!
```
...
translated (by machine 🤖) as:
```
कम से कम एक फ़ोल्डर को हटाने के लिए उप-फ़ोल्डर्स हैं। क्या आप उप-फ़ोल्डर्स को भी हटाना चाहते हैं? हटाए गए फ़ोल्डरों से संबंधित सभी मार्कर स्थायी रूप से हटा दिए जाएंगे!
```
...
translated (by machine 🤖) as:
```
फिलहाल कोई खोज स्रोत कॉन्फ़िगर नहीं किया गया है। खोज करने में सक्षम होने के लिए, आपको तीसरे पक्ष के खोज स्रोत को कॉन्फ़िगर करने की आवश्यकता है।
...
translated (by machine 🤖) as:
```
ऑफ़लाइन मानचित्र फ़ाइल आयात सफल हुआ
```
...
translated (by machine 🤖) as:
```
ऑफ़लाइन मानचित्र फ़ाइल आयात विफल:
%s
```
...
translated (by machine 🤖) as:
```
ऑफ़लाइन मानचित्र फ़ोल्डर खाली है। ऑफ़लाइन मानचित्रों का उपयोग करने के लिए, सेटिंग खोलें और कम से कम एक ऑफ़लाइन मानचित्र फ़ाइल जोड़ें।
```
...
translated (by machine 🤖) as:
```
पैरेंट फ़ोल्डर फ़ील्ड लागू करें
```
...
translated (by machine 🤖) as:
```
समन्वयन निरस्त कर दिया गया क्योंकि निम्न फ़ाइल आपको मिल सकती है: %s. इसे हल करने के लिए, आप या तो लापता फ़ाइल को मैन्युअल रूप से पुनर्स्थापित कर सकते हैं या सिंक के दौरान मीडिया को डाउनलोड न करने के लिए ऐप की सेटिंग बदल सकते हैं।
```
...
translated (by machine 🤖) as:
```
सिंक के दौरान सभी मीडिया डाउनलोड करें
```
...
translated (by machine 🤖) as:
```
जरूरत पड़ने पर सिंक के बाद मीडिया डाउनलोड करें
```
...
translated (by machine 🤖) as:
```
पुराने मानचित्र डेटा तक पहुंचें
```
...
translated (by machine 🤖) as:
```
Map Marker के पुराने संस्करणों से मानचित्र डेटा एक्सेस करने के विकल्प देखें।
```
...
translated (by machine 🤖) as:
```
मैप डेटा माइग्रेट किया जा रहा है…
```
...
translated (by machine 🤖) as:
```
मानचित्र डेटा माइग्रेशन सफल हुआ: अब आप Map Marker के इस नए संस्करण पर अपने पुराने मानचित्र डेटा का उपयोग करने में सक्षम होंगे।
```
...
translated (by machine 🤖) as:
```
मानचित्र डेटा माइग्रेशन विफल: Map Marker के इस नए संस्करण पर आपके पुराने मानचित्र डेटा तक पहुंच संभव नहीं है।
```
...
translated (by machine 🤖) as:
```
ध्यान दें कि पुराना नक्शा डेटा अपरिवर्तित रहता है और आपके डिवाइस पर तब तक बना रहेगा जब तक आप ऐप को अनइंस्टॉल नहीं करते। ऐप को अनइंस्टॉल करने से आपके डिवाइस से सभी Map Marker ऐप डेटा हट जाएगा। यदि आप Map Marker के पुराने संस्करण का उपयोग करना चाहते हैं, तो आप नीचे दिए गए विकल्प पर क्लिक करके उपलब्ध निर्देशों का पालन कर सकते हैं।
```
...
translated (by machine 🤖) as:
```
माइग्रेट करने के लिए V2 मानचित्र का चयन करें
```
...
translated (by machine 🤖) as:
```
लीगेसी V2 क्लाउड मैप माइग्रेशन सफल रहा!
```
...
translated (by machine 🤖) as:
```
चयनित मार्कर को फ़ाइल के रूप में निर्यात करें
```
...
translated (by machine 🤖) as:
```
टूलबार बटन के साथ केंद्र या सर्कल के किनारे का चयन करें और समायोजित करने के लिए मानचित्र को चारों ओर ले जाएं। अंत में, शेप को सेव करने के लिए सेव पर क्लिक करें।
```
...
translated (by machine 🤖) as:
```
पिछले/अगले बटन के साथ बिंदुओं को स्विच करें, बिंदुओं को रखने के लिए मानचित्र को चारों ओर घुमाएँ और एक बिंदु को हटाने के लिए '-' पर क्लिक करें। अंत में संपादित ट्रैक को सहेजने के लिए सेव पर क्लिक करें।
```
...
translated (by machine 🤖) as:
```
किसी अन्य डिवाइस से उत्पन्न कोड से प्रीमियम सक्रिय करें
```
...
translated (by machine 🤖) as:
```
आपने इस डिवाइस पर अतिथि प्रीमियम एक्सेस सक्रिय कर लिया है
```
...
translated (by machine 🤖) as:
```
अपने किसी अन्य डिवाइस पर प्रीमियम सक्रिय करने के लिए प्रीमियम कोड जनरेट करें
```
...
translated (by machine 🤖) as:
```
प्रीमियम कोड सफलतापूर्वक जनरेट किया गया: %s
प्रीमियम को सक्रिय करने के लिए अपने अन्य डिवाइस से इस कोड का उपयोग करें।
```
...
translated (by machine 🤖) as:
```
ऐसा लगता है कि आपका ब्राउज़र पूरी तरह से संगत नहीं है - केवल Google Chrome को पूरी तरह से संगत के रूप में परीक्षण किया गया है
...
translated (by machine 🤖) as:
```
यह आपको एक्सेस क्रेडेंशियल कॉन्फ़िगर करके WebDAV सर्वर से सिंक करने की अनुमति देता है।
```
