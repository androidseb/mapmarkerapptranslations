# Map Marker translations for Serbian (sr)
...
translated (by machine 🤖) as:
```
Преместите фасцикле у фасциклу
```
...
translated (by machine 🤖) as:
```
Унесите свој ИД приступног кључа
```
...
translated (by machine 🤖) as:
```
Унесите свој тајни приступни кључ
```
...
translated (by machine 🤖) as:
```
Увек прикажи подразумевану фасциклу
```
...
translated (by machine 🤖) as:
```
Не можете извршити промене на овој датотеци мапе јер је у режиму само за читање.
```
...
translated (by machine 🤖) as:
```
Гоогле грешка при аутентификацији:
%s
```
...
translated (by machine 🤖) as:
```
Изаберите датотеку офлајн мапе коју желите копирати у директоријум офлајн мапе: %s
```
...
translated (by machine 🤖) as:
```
Обришите датотеке прегледа мапе
```
...
translated (by machine 🤖) as:
```
Обришите датотеке за које се зна да их користи приказ мапе и да се повремено оштећују, што доводи до тога да приказ мапе приказује празну позадину.
```
...
translated (by machine 🤖) as:
```
Датотеке прегледа мапе су успешно обрисане. Апликација ће се сада затворити да заврши чишћење.
```
...
translated (by machine 🤖) as:
```
Није могуће обрисати датотеке приказа мапе
```
...
translated (by machine 🤖) as:
```
Следеће велико ажурирање за Map Marker стиже ускоро! Та нова верзија ће донети важна побољшања и нове функције.

Ажурирање апликације ће остати бесплатно и опционо, кликните на „Погледајте више“ да бисте сазнали више информација.
```
