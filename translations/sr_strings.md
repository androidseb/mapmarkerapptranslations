...
translated (by machine 🤖) as:
```
Користи изворни Google Maps приказ
```
...
translated (by machine 🤖) as:
```
Овај режим приказа може бити спорији, али је мања вероватноћа да ће изазвати падове апликације
```
...
translated (by machine 🤖) as:
```
(тренутни избор није примењен, захтева потпуно поновно покретање апликације)
```
