...
translated (by human 👀) as:
```
Vider les fichiers connus pour être utilisés par la vue de la carte et pour se corrompre occasionellement, résultant en une vue de fond de carte vide.
```
...
translated (by human 👀) as:
```
Fichiers de vue carte vidés avec succès. L'application va maintenant s'arrêter pour finaliser le nettoyage.
```
...
translated (by human 👀) as:
```
Impossible de vider les fichiers de vue carte
```
...
translated (by human 👀) as:
```
La prochaine mise à jour majeure de Map Marker arrive bientôt ! Cette nouvelle version apportera des améliorations et nouvelles fonctionnalités importantes.

La mise à jour de l'application restera gratuite et optionelle, cliquez "Voir plus" pour en apprendre plus.
```
...
translated (by human 👀) as:
```
Aucun dossier de carte trouvé sur le cloud - si vous recherchez d'anciennes versions de carte cloud créées avec l'ancienne version de Map Marker (V2), essayez l'option 'Ouvrir et migrer une carte cloud V2' à la place.
```
