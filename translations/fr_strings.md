...
translated (by machine 🤖) as:
```
Tracés de localisation en cours
```
...
translated (by machine 🤖) as:
```
Il semble que votre navigateur ne soit pas Google Chrome - seulement Google Chrome est testé comme pleinement compatible.
```
