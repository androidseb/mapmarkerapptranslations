...
translated (by machine 🤖) as:
```
Μπορείτε να αναζητήσετε μέρη με "%s". Αυτή η αναζήτηση απαιτεί σύνδεση στο διαδίκτυο. Εισαγάγετε την αναζήτησή σας και μετά πατήστε enter.
```
...
translated (by machine 🤖) as:
```
Algolia Places Search API (ημερήσιο όριο)
```
...
translated (by machine 🤖) as:
```
Algolia Places Search API (προσωπικός λογαριασμός)
```
...
translated (by machine 🤖) as:
```
Μπορείτε can επιλέξτε μόνο ένα αρχείο για να εισάγετε χρόνο at a
```
...
translated (by machine 🤖) as:
```
Μπορείτε can να εισάγετε μόνο αρχεία με τις ακόλουθες επεκτάσεις: %s
```
...
translated (by machine 🤖) as:
```
Επιλέξτε ένα αρχείο χάρτη εκτός σύνδεσης για αντιγραφή στο φάκελο χαρτών εκτός σύνδεσης: %s
```
...
translated (by machine 🤖) as:
```
Εισαγωγή αρχείου χάρτη εκτός σύνδεσης ...
```
...
translated (by machine 🤖) as:
```
Λόγω ορισμένων περιορισμών στη ροή ελέγχου ταυτότητας Google, δεν είναι δυνατός ο έλεγχος ταυτότητας με διαφορετικό επίπεδο άδειας (περιορισμένη πρόσβαση / πλήρης πρόσβαση), εκτός εάν φορτώσετε ξανά την ιστοσελίδα. Εκτελέστε την ενέργεια ανανέωσης στο πρόγραμμα περιήγησής σας και δοκιμάστε ξανά.
```
