...
translates to:
```
Поворачивать карту в направлении движения в режиме навигации
```
...
translates to:
```
Удерживайте, чтобы перемещать маркер
```
...
translates to:
```
Проверяет, что приложение может сохранять файлы на внутреннюю SD-карту
```
...
translates to:
```
Здесь будет список Ваших маркеров. В настоящее время маркеры в выбранной папках отсутствуют. Добавьте новый маркер, нажав на эту кнопку.
```
...
translates to:
```
Формат Zip Google Earth. Может содержать медиафайлы.
```
...
translates to:
```
У целевой папки другие поля. Выберите поля, если хотите применить их к перемещаемым маркерам.
```
...
Я занимался этим приложением в свободное время, это было хобби, помимо полного рабочего дня, впоследствии это стало сторонним проектом, на которое уже ушло более 4 лет.

Надеюсь, приложение вам нравится и сыграло вам пользу. Я сделал его таким образом, чтобы предоставить вам все возможности бесплатно, пускай на некоторые из них вам может потребоваться чуть больше усилий. Вы можете импортировать или экспортировать данные самостоятельно, так что нет реальной необходимости платить за что-либо, просто удобнее пользоваться облачной синхронизацией.
