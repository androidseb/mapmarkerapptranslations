...
translated (by machine 🤖) as:
```
Odaberite datoteku izvanmrežne karte koju želite kopirati u mapu izvanmrežnih karata: %s
```
...
translated (by machine 🤖) as:
```
Uvoz datoteke izvanmrežne karte ...
```
...
translated (by machine 🤖) as:
```
Obrišite datoteke za koje se zna da ih koristi prikaz karte i koje se povremeno oštećuju, uzrokujući da prikaz karte prikazuje praznu pozadinu.
```
...
translated (by machine 🤖) as:
```
Datoteke prikaza karte uspješno su izbrisane. Aplikacija će sada izaći da dovrši čišćenje.
```
...
translated (by machine 🤖) as:
```
Nije moguće izbrisati datoteke prikaza karte
```
...
translated (by machine 🤖) as:
```
Sljedeće veliko ažuriranje za Map Marker dolazi uskoro! Ta nova verzija donijet će važna poboljšanja i nove značajke.

Ažuriranje aplikacije ostat će besplatno i izborno, kliknite "Vidi više" da biste saznali više informacija.
```
