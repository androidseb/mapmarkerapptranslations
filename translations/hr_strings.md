...
translated (by machine 🤖) as:
```
Koristi izvorni Google Maps prikaz
```
...
translated (by machine 🤖) as:
```
Ovaj način prikaza može biti sporiji, ali je manja vjerojatnost da će uzrokovati rušenje aplikacije
```
...
translated (by machine 🤖) as:
```
(trenutni odabir nije primijenjen, potrebno je potpuno ponovno pokretanje aplikacije)
```
