...
translated (by machine 🤖) as:
```
Kvadratinis metras (m²) / Hektaras (ha) / Kvadratinis kilometras (km²)
```
...
translated (by machine 🤖) as:
```
Kvadratinė pėda (ft²) / Akras (ac) / Kvadratinė mylia (mi²)
```
...
translated (by machine 🤖) as:
```
Metrinė sistema: metrai / kilometrai
```
