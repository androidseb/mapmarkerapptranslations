...
translated (by machine 🤖) as:
```
Uporabi izvorni pogled Google Maps
```
...
translated (by machine 🤖) as:
```
Ta način prikaza je morda počasnejši, vendar je manj verjetno, da bo povzročil zrušitve aplikacije.
```
...
translated (by machine 🤖) as:
```
(trenutna izbira ni uporabljena, zahteva popoln ponovni zagon aplikacije)
```
